...
console.log('1', fuzzy_match("cgf", "consulta geral financeira"));
console.log('2', fuzzy_match("cgf", "Arrecadacao consulta geral financeira"));
console.log('3', fuzzy_match("cgf", "Arrecadacao Consulta Geral financeira"));
console.log('4', fuzzy_match("cgf", "Arrecadacao ConsultaGeralFinanceira"));
console.log('5', fuzzy_match("cgf", "Arrecadacao Consulta"));
console.log('6', fuzzy_match("cgf", "Arrecadacao Financeira"));
console.log('7', fuzzy_match("cgf", "arrecadacao financeira"));
console.log('8', fuzzy_match("cgf", "DB:TRIBUTÁRIO > Arrecadação > Consultas > Geral Financeira"));
console.log('9', fuzzy_match("consulta geral financeira", "DB:TRIBUTÁRIO > Arrecadação > Consultas > Geral Financeira"));
console.log('10', fuzzy_match("consulta financeira", "DB:TRIBUTÁRIO > Arrecadação > Consultas > Geral Financeira"));
